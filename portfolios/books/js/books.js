ready(function () {
  $.get('/database/api/v1/portfolios/books', function (books) {
    books.forEach(function (book) {
      ...
      var el_div1_img0 = $('<img />', { class: 'meta__avatar' })
      var el_div1_span0 = $('<span />', { class: 'meta__date' })
      var el_div1_span1 = $('<span />', { class: 'meta__reading-time' })
